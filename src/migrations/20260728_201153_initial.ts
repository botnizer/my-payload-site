...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_cta_banner_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_case_studies_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum_pages_blocks_feature_row_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_feature_row_media_position" AS ENUM('right', 'left');
  CREATE TYPE "public"."enum_pages_blocks_hero_slider_slides_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_pill_categories_pills_tone" AS ENUM('green', 'blue', 'purple', 'orange');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_cta_banner_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_case_studies_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum__pages_v_blocks_feature_row_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_feature_row_media_position" AS ENUM('right', 'left');
  CREATE TYPE "public"."enum__pages_v_blocks_hero_slider_slides_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_pill_categories_pills_tone" AS ENUM('green', 'blue', 'purple', 'orange');
  ...
  CREATE TYPE "public"."enum_solutions_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_solutions_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__solutions_v_version_links_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TYPE "public"."enum_footer_cta_card_links_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('facebook', 'instagram', 'linkedin', 'x', 'youtube');
  ...
  CREATE TABLE "pages_blocks_cta_banner_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_pages_blocks_cta_banner_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar
  );
  ...
  CREATE TABLE "pages_blocks_trust_bar_logos" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"logo_id" integer,
  ...
  CREATE TABLE "pages_blocks_solutions_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"eyebrow" varchar DEFAULT 'Our offerings',
  	"heading" varchar,
  	"intro" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_case_studies" (
  	...
  	"intro" varchar,
  	"populate_by" "enum_pages_blocks_case_studies_populate_by" DEFAULT 'collection',
  	"limit" numeric DEFAULT 3,
  	"link_label" varchar,
  	"link_url" varchar DEFAULT '/case-studies',
  	"block_name" varchar
  );
  
  CREATE TABLE "pages_blocks_contact_split_steps" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "pages_blocks_contact_split" (
  	...
  	"intro" varchar,
  	"form_id" integer,
  	"panel_title" varchar DEFAULT 'What happens next?',
  	"block_name" varchar
  );
  
  CREATE TABLE "pages_blocks_feature_row_bullets" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar
  ...
  CREATE TABLE "pages_blocks_feature_row_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_pages_blocks_feature_row_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar
  );
  
  CREATE TABLE "pages_blocks_feature_row" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	...
  	"description" varchar,
  	"image_id" integer,
  	"media_position" "enum_pages_blocks_feature_row_media_position" DEFAULT 'right',
  	"block_name" varchar
  );
  
  CREATE TABLE "pages_blocks_hero_slider_slides_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_pages_blocks_hero_slider_slides_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar
  );
  ...
  CREATE TABLE "pages_blocks_media_collage_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer
  ...
  CREATE TABLE "pages_blocks_media_collage" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_pill_categories_pills" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar,
  	"tone" "enum_pages_blocks_pill_categories_pills_tone" DEFAULT 'green'
  );
  
  CREATE TABLE "pages_blocks_pill_categories" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_cta_banner_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"link_type" "enum__pages_v_blocks_cta_banner_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"_uuid" varchar
  ...
  CREATE TABLE "_pages_v_blocks_trust_bar_logos" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"logo_id" integer,
  ...
  CREATE TABLE "_pages_v_blocks_solutions_grid" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_case_studies" (
  	...
  	"heading" varchar DEFAULT 'Success Stories',
  	"intro" varchar,
  	"populate_by" "enum__pages_v_blocks_case_studies_populate_by" DEFAULT 'collection',
  	"limit" numeric DEFAULT 3,
  	"link_label" varchar,
  	"link_url" varchar DEFAULT '/case-studies',
  	"_uuid" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_contact_split_steps" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_feature_row_bullets" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"label" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_feature_row_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"link_type" "enum__pages_v_blocks_feature_row_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"_uuid" varchar
  ...
  CREATE TABLE "_pages_v_blocks_feature_row" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	...
  	"description" varchar,
  	"image_id" integer,
  	"media_position" "enum__pages_v_blocks_feature_row_media_position" DEFAULT 'right',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE "_pages_v_blocks_hero_slider_slides_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"link_type" "enum__pages_v_blocks_hero_slider_slides_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"_uuid" varchar
  ...
  CREATE TABLE "_pages_v_blocks_media_collage_images" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE "_pages_v_blocks_media_collage" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_pill_categories_pills" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"label" varchar,
  	"tone" "enum__pages_v_blocks_pill_categories_pills_tone" DEFAULT 'green',
  	"_uuid" varchar
  );
  
  CREATE TABLE "_pages_v_blocks_pill_categories" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_case_studies_v" (
  	...
  	"version_title" varchar,
  	"version_hero_image_id" integer,
  	"version_solution_summary" varchar,
  	"version_results_summary" varchar,
  	"version_overview" jsonb,
  	"version_objectives" jsonb,
  	"version_solutions" jsonb,
  ...
  CREATE TABLE "solutions_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_solutions_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar
  );
  ...
  CREATE TABLE "_solutions_v_version_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"link_type" "enum__solutions_v_version_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"_uuid" varchar
  ...
  CREATE TABLE "footer_cta_card_links" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_cta_card_links_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar NOT NULL
  );
  ...
  CREATE TABLE "footer" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"logo_id" integer,
  	"heading" varchar DEFAULT 'Let''s Connect Today',
  	"tagline" varchar,
  	"cta_card_title" varchar,
  	"cta_card_description" varchar,
  	"copyright" varchar,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "pages_blocks_cta_banner_links" ADD CONSTRAINT "pages_blocks_cta_banner_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_cta_banner"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_trust_bar_logos" ADD CONSTRAINT "pages_blocks_trust_bar_logos_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_trust_bar_logos" ADD CONSTRAINT "pages_blocks_trust_bar_logos_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_trust_bar"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_solutions_grid" ADD CONSTRAINT "pages_blocks_solutions_grid_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_contact_split_steps" ADD CONSTRAINT "pages_blocks_contact_split_steps_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_contact_split"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_contact_split" ADD CONSTRAINT "pages_blocks_contact_split_form_id_forms_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_feature_row_bullets" ADD CONSTRAINT "pages_blocks_feature_row_bullets_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_feature_row"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_feature_row_links" ADD CONSTRAINT "pages_blocks_feature_row_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_feature_row"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_feature_row" ADD CONSTRAINT "pages_blocks_feature_row_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_feature_row" ADD CONSTRAINT "pages_blocks_feature_row_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_hero_slider_slides_links" ADD CONSTRAINT "pages_blocks_hero_slider_slides_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_hero_slider_slides"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "pages_blocks_media_collage_images" ADD CONSTRAINT "pages_blocks_media_collage_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_media_collage_images" ADD CONSTRAINT "pages_blocks_media_collage_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_media_collage"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_media_collage" ADD CONSTRAINT "pages_blocks_media_collage_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_pill_categories_pills" ADD CONSTRAINT "pages_blocks_pill_categories_pills_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_pill_categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "pages_blocks_pill_categories" ADD CONSTRAINT "pages_blocks_pill_categories_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_cta_banner_links" ADD CONSTRAINT "_pages_v_blocks_cta_banner_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_cta_banner"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_trust_bar_logos" ADD CONSTRAINT "_pages_v_blocks_trust_bar_logos_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_trust_bar_logos" ADD CONSTRAINT "_pages_v_blocks_trust_bar_logos_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_trust_bar"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_solutions_grid" ADD CONSTRAINT "_pages_v_blocks_solutions_grid_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_contact_split_steps" ADD CONSTRAINT "_pages_v_blocks_contact_split_steps_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_contact_split"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_contact_split" ADD CONSTRAINT "_pages_v_blocks_contact_split_form_id_forms_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."forms"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_feature_row_bullets" ADD CONSTRAINT "_pages_v_blocks_feature_row_bullets_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_feature_row"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_feature_row_links" ADD CONSTRAINT "_pages_v_blocks_feature_row_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_feature_row"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_feature_row" ADD CONSTRAINT "_pages_v_blocks_feature_row_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_feature_row" ADD CONSTRAINT "_pages_v_blocks_feature_row_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_hero_slider_slides_links" ADD CONSTRAINT "_pages_v_blocks_hero_slider_slides_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_hero_slider_slides"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_media_collage_images" ADD CONSTRAINT "_pages_v_blocks_media_collage_images_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_media_collage_images" ADD CONSTRAINT "_pages_v_blocks_media_collage_images_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_media_collage"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_media_collage" ADD CONSTRAINT "_pages_v_blocks_media_collage_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_pill_categories_pills" ADD CONSTRAINT "_pages_v_blocks_pill_categories_pills_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_pill_categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_pill_categories" ADD CONSTRAINT "_pages_v_blocks_pill_categories_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "case_studies" ADD CONSTRAINT "case_studies_testimonial_avatar_id_media_id_fk" FOREIGN KEY ("testimonial_avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_case_studies_v" ADD CONSTRAINT "_case_studies_v_version_testimonial_avatar_id_media_id_fk" FOREIGN KEY ("version_testimonial_avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "solutions_links" ADD CONSTRAINT "solutions_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."solutions"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_solutions_v_version_links" ADD CONSTRAINT "_solutions_v_version_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_solutions_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "footer_cta_card_links" ADD CONSTRAINT "footer_cta_card_links_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_cta_banner_links_order_idx" ON "pages_blocks_cta_banner_links" USING btree ("_order");
  CREATE INDEX "pages_blocks_cta_banner_links_parent_id_idx" ON "pages_blocks_cta_banner_links" USING btree ("_parent_id");
  ...
  CREATE INDEX "pages_blocks_trust_bar_logos_order_idx" ON "pages_blocks_trust_bar_logos" USING btree ("_order");
  CREATE INDEX "pages_blocks_trust_bar_logos_parent_id_idx" ON "pages_blocks_trust_bar_logos" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_trust_bar_logos_logo_idx" ON "pages_blocks_trust_bar_logos" USING btree ("logo_id");
  ...
  CREATE INDEX "pages_blocks_solutions_grid_order_idx" ON "pages_blocks_solutions_grid" USING btree ("_order");
  CREATE INDEX "pages_blocks_solutions_grid_parent_id_idx" ON "pages_blocks_solutions_grid" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_solutions_grid_path_idx" ON "pages_blocks_solutions_grid" USING btree ("_path");
  ...
  CREATE INDEX "pages_blocks_contact_split_steps_order_idx" ON "pages_blocks_contact_split_steps" USING btree ("_order");
  CREATE INDEX "pages_blocks_contact_split_steps_parent_id_idx" ON "pages_blocks_contact_split_steps" USING btree ("_parent_id");
  ...
  CREATE INDEX "pages_blocks_contact_split_form_idx" ON "pages_blocks_contact_split" USING btree ("form_id");
  CREATE INDEX "pages_blocks_feature_row_bullets_order_idx" ON "pages_blocks_feature_row_bullets" USING btree ("_order");
  CREATE INDEX "pages_blocks_feature_row_bullets_parent_id_idx" ON "pages_blocks_feature_row_bullets" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_feature_row_links_order_idx" ON "pages_blocks_feature_row_links" USING btree ("_order");
  CREATE INDEX "pages_blocks_feature_row_links_parent_id_idx" ON "pages_blocks_feature_row_links" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_feature_row_order_idx" ON "pages_blocks_feature_row" USING btree ("_order");
  CREATE INDEX "pages_blocks_feature_row_parent_id_idx" ON "pages_blocks_feature_row" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_feature_row_path_idx" ON "pages_blocks_feature_row" USING btree ("_path");
  CREATE INDEX "pages_blocks_feature_row_image_idx" ON "pages_blocks_feature_row" USING btree ("image_id");
  CREATE INDEX "pages_blocks_hero_slider_slides_links_order_idx" ON "pages_blocks_hero_slider_slides_links" USING btree ("_order");
  CREATE INDEX "pages_blocks_hero_slider_slides_links_parent_id_idx" ON "pages_blocks_hero_slider_slides_links" USING btree ("_parent_id");
  ...
  CREATE INDEX "pages_blocks_media_collage_images_order_idx" ON "pages_blocks_media_collage_images" USING btree ("_order");
  CREATE INDEX "pages_blocks_media_collage_images_parent_id_idx" ON "pages_blocks_media_collage_images" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_media_collage_images_image_idx" ON "pages_blocks_media_collage_images" USING btree ("image_id");
  CREATE INDEX "pages_blocks_media_collage_order_idx" ON "pages_blocks_media_collage" USING btree ("_order");
  CREATE INDEX "pages_blocks_media_collage_parent_id_idx" ON "pages_blocks_media_collage" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_media_collage_path_idx" ON "pages_blocks_media_collage" USING btree ("_path");
  CREATE INDEX "pages_blocks_pill_categories_pills_order_idx" ON "pages_blocks_pill_categories_pills" USING btree ("_order");
  CREATE INDEX "pages_blocks_pill_categories_pills_parent_id_idx" ON "pages_blocks_pill_categories_pills" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_pill_categories_order_idx" ON "pages_blocks_pill_categories" USING btree ("_order");
  CREATE INDEX "pages_blocks_pill_categories_parent_id_idx" ON "pages_blocks_pill_categories" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_pill_categories_path_idx" ON "pages_blocks_pill_categories" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_cta_banner_links_order_idx" ON "_pages_v_blocks_cta_banner_links" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_cta_banner_links_parent_id_idx" ON "_pages_v_blocks_cta_banner_links" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_trust_bar_logos_order_idx" ON "_pages_v_blocks_trust_bar_logos" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_trust_bar_logos_parent_id_idx" ON "_pages_v_blocks_trust_bar_logos" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_trust_bar_logos_logo_idx" ON "_pages_v_blocks_trust_bar_logos" USING btree ("logo_id");
  ...
  CREATE INDEX "_pages_v_blocks_solutions_grid_order_idx" ON "_pages_v_blocks_solutions_grid" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_solutions_grid_parent_id_idx" ON "_pages_v_blocks_solutions_grid" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_solutions_grid_path_idx" ON "_pages_v_blocks_solutions_grid" USING btree ("_path");
  ...
  CREATE INDEX "_pages_v_blocks_contact_split_steps_order_idx" ON "_pages_v_blocks_contact_split_steps" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_contact_split_steps_parent_id_idx" ON "_pages_v_blocks_contact_split_steps" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_contact_split_form_idx" ON "_pages_v_blocks_contact_split" USING btree ("form_id");
  CREATE INDEX "_pages_v_blocks_feature_row_bullets_order_idx" ON "_pages_v_blocks_feature_row_bullets" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_feature_row_bullets_parent_id_idx" ON "_pages_v_blocks_feature_row_bullets" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_feature_row_links_order_idx" ON "_pages_v_blocks_feature_row_links" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_feature_row_links_parent_id_idx" ON "_pages_v_blocks_feature_row_links" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_feature_row_order_idx" ON "_pages_v_blocks_feature_row" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_feature_row_parent_id_idx" ON "_pages_v_blocks_feature_row" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_feature_row_path_idx" ON "_pages_v_blocks_feature_row" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_feature_row_image_idx" ON "_pages_v_blocks_feature_row" USING btree ("image_id");
  CREATE INDEX "_pages_v_blocks_hero_slider_slides_links_order_idx" ON "_pages_v_blocks_hero_slider_slides_links" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_hero_slider_slides_links_parent_id_idx" ON "_pages_v_blocks_hero_slider_slides_links" USING btree ("_parent_id");
  ...
  CREATE INDEX "_pages_v_blocks_media_collage_images_order_idx" ON "_pages_v_blocks_media_collage_images" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_media_collage_images_parent_id_idx" ON "_pages_v_blocks_media_collage_images" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_media_collage_images_image_idx" ON "_pages_v_blocks_media_collage_images" USING btree ("image_id");
  CREATE INDEX "_pages_v_blocks_media_collage_order_idx" ON "_pages_v_blocks_media_collage" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_media_collage_parent_id_idx" ON "_pages_v_blocks_media_collage" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_media_collage_path_idx" ON "_pages_v_blocks_media_collage" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_pill_categories_pills_order_idx" ON "_pages_v_blocks_pill_categories_pills" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_pill_categories_pills_parent_id_idx" ON "_pages_v_blocks_pill_categories_pills" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_pill_categories_order_idx" ON "_pages_v_blocks_pill_categories" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_pill_categories_parent_id_idx" ON "_pages_v_blocks_pill_categories" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_pill_categories_path_idx" ON "_pages_v_blocks_pill_categories" USING btree ("_path");
  ...
  CREATE INDEX "case_studies_testimonial_testimonial_avatar_idx" ON "case_studies" USING btree ("testimonial_avatar_id");
  ...
  CREATE INDEX "_case_studies_v_version_testimonial_version_testimonial__idx" ON "_case_studies_v" USING btree ("version_testimonial_avatar_id");
  ...
  CREATE INDEX "solutions_links_order_idx" ON "solutions_links" USING btree ("_order");
  CREATE INDEX "solutions_links_parent_id_idx" ON "solutions_links" USING btree ("_parent_id");
  ...
  CREATE INDEX "solutions_rels_pages_id_idx" ON "solutions_rels" USING btree ("pages_id");
  CREATE INDEX "solutions_rels_posts_id_idx" ON "solutions_rels" USING btree ("posts_id");
  CREATE INDEX "_solutions_v_version_links_order_idx" ON "_solutions_v_version_links" USING btree ("_order");
  CREATE INDEX "_solutions_v_version_links_parent_id_idx" ON "_solutions_v_version_links" USING btree ("_parent_id");
  ...
  CREATE INDEX "_solutions_v_rels_pages_id_idx" ON "_solutions_v_rels" USING btree ("pages_id");
  CREATE INDEX "_solutions_v_rels_posts_id_idx" ON "_solutions_v_rels" USING btree ("posts_id");
  ...
  CREATE INDEX "footer_cta_card_links_order_idx" ON "footer_cta_card_links" USING btree ("_order");
  CREATE INDEX "footer_cta_card_links_parent_id_idx" ON "footer_cta_card_links" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_cta_banner_links" CASCADE;
  ...
  DROP TABLE "pages_blocks_trust_bar_logos" CASCADE;
  DROP TABLE "pages_blocks_trust_bar" CASCADE;
  DROP TABLE "pages_blocks_solutions_grid" CASCADE;
  DROP TABLE "pages_blocks_case_studies" CASCADE;
  DROP TABLE "pages_blocks_contact_split_steps" CASCADE;
  DROP TABLE "pages_blocks_contact_split" CASCADE;
  DROP TABLE "pages_blocks_feature_row_bullets" CASCADE;
  DROP TABLE "pages_blocks_feature_row_links" CASCADE;
  DROP TABLE "pages_blocks_feature_row" CASCADE;
  DROP TABLE "pages_blocks_hero_slider_slides_links" CASCADE;
  DROP TABLE "pages_blocks_hero_slider_slides" CASCADE;
  DROP TABLE "pages_blocks_hero_slider" CASCADE;
  DROP TABLE "pages_blocks_media_collage_images" CASCADE;
  DROP TABLE "pages_blocks_media_collage" CASCADE;
  DROP TABLE "pages_blocks_pill_categories_pills" CASCADE;
  DROP TABLE "pages_blocks_pill_categories" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_cta_banner_links" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_trust_bar_logos" CASCADE;
  DROP TABLE "_pages_v_blocks_trust_bar" CASCADE;
  DROP TABLE "_pages_v_blocks_solutions_grid" CASCADE;
  DROP TABLE "_pages_v_blocks_case_studies" CASCADE;
  DROP TABLE "_pages_v_blocks_contact_split_steps" CASCADE;
  DROP TABLE "_pages_v_blocks_contact_split" CASCADE;
  DROP TABLE "_pages_v_blocks_feature_row_bullets" CASCADE;
  DROP TABLE "_pages_v_blocks_feature_row_links" CASCADE;
  DROP TABLE "_pages_v_blocks_feature_row" CASCADE;
  DROP TABLE "_pages_v_blocks_hero_slider_slides_links" CASCADE;
  DROP TABLE "_pages_v_blocks_hero_slider_slides" CASCADE;
  DROP TABLE "_pages_v_blocks_hero_slider" CASCADE;
  DROP TABLE "_pages_v_blocks_media_collage_images" CASCADE;
  DROP TABLE "_pages_v_blocks_media_collage" CASCADE;
  DROP TABLE "_pages_v_blocks_pill_categories_pills" CASCADE;
  DROP TABLE "_pages_v_blocks_pill_categories" CASCADE;
  ...
  DROP TABLE "solutions_links" CASCADE;
  DROP TABLE "solutions" CASCADE;
  DROP TABLE "solutions_rels" CASCADE;
  DROP TABLE "_solutions_v_version_links" CASCADE;
  ...
  DROP TABLE "footer_cta_card_links" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_cta_banner_links_link_type";
  DROP TYPE "public"."enum_pages_blocks_case_studies_populate_by";
  DROP TYPE "public"."enum_pages_blocks_feature_row_links_link_type";
  DROP TYPE "public"."enum_pages_blocks_feature_row_media_position";
  DROP TYPE "public"."enum_pages_blocks_hero_slider_slides_links_link_type";
  DROP TYPE "public"."enum_pages_blocks_pill_categories_pills_tone";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_cta_banner_links_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_case_studies_populate_by";
  DROP TYPE "public"."enum__pages_v_blocks_feature_row_links_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_feature_row_media_position";
  DROP TYPE "public"."enum__pages_v_blocks_hero_slider_slides_links_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_pill_categories_pills_tone";
  ...
  DROP TYPE "public"."enum_solutions_links_link_type";
  DROP TYPE "public"."enum_solutions_status";
  DROP TYPE "public"."enum__solutions_v_version_links_link_type";
  ...
  DROP TYPE "public"."enum_footer_cta_card_links_link_type";
