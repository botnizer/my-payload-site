...
export interface CaseStudy {
  id: number;
  /**
   * The challenge headline, e.g. "Managing complex customizations during lunch rush".
   */
  title: string;
  heroImage?: (number | null) | Media;
  /**
   * One line, e.g. "Botnizer Smart Modifiers & Station Routing".
   */
  solutionSummary?: string | null;
  /**
   * One line, e.g. "40% faster build times, 95% order accuracy".
   */
  ...
  /**
   * The headline numbers, e.g. "+34%" / "Increase in peak hour throughput".
   */
  metrics?:
    | {
        value: string;
    ...
    | null;
  /**
   * Photo collage shown partway down the detail page.
   */
  gallery?:
    | {
        image: number | Media;
    ...
    | null;
  /**
   * Hidden on the site when the quote is empty.
   */
  testimonial?: {
    quote?: string | null;
    name?: string | null;
  ...
  /**
   * Which products this story showcases.
   */
...
export interface Header {
  id: number;
  /**
   * Falls back to the bundled logo when left empty.
   */
...
export interface Footer {
  ...
  heading?: string | null;
  /**
   * Short paragraph shown beside the heading.
   */
  tagline?: string | null;
  columns?:
    | {
    ...
    | null;
  /**
   * The 'Let's Get Started' card. Hidden on the site when the title is empty.
   */
  ctaCard?: {
    title?: string | null;
    description?: string | null;
  ...
  socialLinks?:
    ...
    | null;
  /**
   * Example: ©2025 Botnizer. All rights reserved.
   */
